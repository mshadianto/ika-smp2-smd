...
// ============================================================
// Note: Install @supabase/supabase-js: npm install @supabase/supabase-js
...
export const SUPABASE_URL = "https://fjodyrcbpwhdkbcbctdt.supabase.co";
export const SUPABASE_ANON_KEY = import.meta.env?.VITE_SUPABASE_ANON_KEY || "";

// Feature flag — set to false to force local storage mode (dev/offline)
...
// Database table names — centralized for refactoring safety
export const TABLES = {
  ALUMNI: "alumni",
  MARKET: "market_items",
  UMKM: "umkm",
...
-- MARKETPLACE: admin-only write (per user requirement)
create policy "admin_write_market" on market_items
  for all using (is_admin()) with check (is_admin());

-- ALUMNI: anyone can insert (self-registration), only admin can delete/update others
...
-- UMKM: anyone can insert (registered alumni), admin can manage all
